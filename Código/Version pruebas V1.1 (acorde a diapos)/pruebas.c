...
void mostrarOpciones(void){
	...
	printf("\t 3)Prueba 3: Hay un proceso en ejecución, dos en cola y llega un nuevo proceso (cambio de contexto a MED_LOAD)\n");
	printf("\t 4)Prueba 4: Hay un proceso en ejecución, cuatro en cola y llega un nuevo proceso(MED_LOAD sin cambio)\n");
	printf("\t 5)Prueba 5: Hay un proceso en ejecución, cinco en cola y llega un nuevo proceso (Se descarta, con cambio de contexto)\n");
	printf("\t 6)Prueba 6: Hay un proceso en ejecucion, cinco en cola y llega un nuevo proceso pagos (con cambio de contexto)");
	printf("\t 7)Prueba 7: Entra a cola proceso de tipo eventos en HIGH_LOAD  (sin cambio de contexto) \n");
	printf("\t 8)Prueba 8: Sustitución de proceso en HIGH_LOAD (con cambio de contexto)(\n");
...
void prueba3(void){
	printf("\n\n\n\n\n\n\n\n\n");
	printf("Prueba 3: Cambio de contexto en LOW_LOAD a MED_LOAD\n");
...
void prueba4(void){
	...
	void prueba5(void){
		printf("\n\n\n\n\n\n\n\n\n");
		printf("Prueba 5:MED_LOAD to HIGH_LOAD (descarte de gradas) \n");
...
void prueba6(void){
	printf("\n\n\n\n\n\n\n\n\n");
	printf("Prueba 6:  HIGH_LOAD con cambio de contexto mete pagos\n");
...
void prueba7(void){
	printf("\n\n\n\n\n\n\n\n\n");
	printf("Prueba 7:  HIGH_LOAD (sin cambio de contexto, descarta)\n");
...
void prueba8(void){
	printf("\n\n\n\n\n\n\n\n\n");
	printf("Prueba 8:  Sustitución de proceso para high load (con cambio de contexto)\n");
