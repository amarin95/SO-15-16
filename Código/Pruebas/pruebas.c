...
printf( "\n\n\n\n\n\n\n\n\n\n\n\n\n" );
	...
	printf("\t 1)Prueba 1: Incluir un proceso en cola\n");
	printf("\t 2)Prueba 2: Llegada de dos procesos,cancelaciones y luego pagos\n");
	printf("\t 3)Prueba 3:Llegada de dos procesos, LOW_LOAD, pago y luego cancelaciones\n");
	printf("\t 4)Prueba 4: Proceso con dos en cola, cambio de contexto\n");
	printf("\t 5)Prueba 5: Proceso llegando en MED_LOAD\n");
	printf("\t 6)Prueba 6: Cambio contexto MED_LOAD -> HIGH_LOAD, descarta proceso\n");
	...
	for(i=0; i<1;i++){
	  ...
	  case 0:
		...
		if( pid == -1 ){
			...
			printf( "\nLlega un proceso de tipo cancelaciones");
...
void prueba2(void){
   printf("\n\n\n\n\n\n\n\n\n");
   printf("Prueba 2: Llegada de dos procesos\n");
